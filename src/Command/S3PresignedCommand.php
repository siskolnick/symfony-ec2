...
class S3PresignedCommand extends Command
{
    protected static $defaultName = 'app:s3-presigned';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $presignedUrl = $this->service->getPresignedFileURL($file_name, 'assets/',true,1);
